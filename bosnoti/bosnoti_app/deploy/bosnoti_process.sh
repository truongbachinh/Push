#!/bin/bash
readonly PROC_NAME="com.app.BosNotifyApp"
readonly DAEMON="-cp bosnoti-app.jar:libs/* com.app.BosNotifyApp"
readonly PID_PATH="/user/stock/bospro_noti/"
readonly PROC_PID="${PID_PATH}${PROC_NAME}.pid"
readonly SPRING_PROFILES_ACTIVE="nhreal"
readonly SPRING_COMMANDLINE="bosnotistart"
